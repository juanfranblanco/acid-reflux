...
export default React.createClass({
  ...
  buildGraph() {
    ...
    if(forceGraphContainer.width &&
      ...
      window.onresize = () => {
        var width  = React.findDOMNode(this.refs.forceGraphContainer).clientWidth;
        var height = React.findDOMNode(this.refs.forceGraphContainer).clientHeight;

        if(React.findDOMNode(this.refs.forceGraphContainer) !== null){
